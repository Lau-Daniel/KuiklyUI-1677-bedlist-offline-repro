...
package com.tencent.kuikly.compose.foundation.text.selection
...
private val DefaultSelectionColor = Color(0xFF3478F6)

@Stable
internal val DefaultTextSelectionColors: TextSelectionColors = TextSelectionColors(
