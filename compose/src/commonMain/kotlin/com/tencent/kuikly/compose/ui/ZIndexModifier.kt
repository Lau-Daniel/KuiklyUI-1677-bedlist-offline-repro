 ...
 *
 * @sample com.tencent.kuikly.compose.ui.samples.ZIndexModifierSample
 */
@Stable
fun Modifier.zIndex(zIndex: Float): Modifier = setProp("zIndex", zIndex) then ZIndexElement(zIndex = zIndex)
