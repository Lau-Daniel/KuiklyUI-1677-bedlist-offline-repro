...
value class TextDirection internal constructor(internal val value: Int) {
    ...
    companion object {
         ...
         * [com.tencent.kuikly.compose.ui.unit.LayoutDirection] is used to resolve the final TextDirection.
         * * if used while creating a Paragraph object, [com.tencent.kuikly.compose.ui.text.intl.LocaleList] will
         * be used to resolve the direction as a fallback instead of
         * [com.tencent.kuikly.compose.ui.unit.LayoutDirection].
         */
