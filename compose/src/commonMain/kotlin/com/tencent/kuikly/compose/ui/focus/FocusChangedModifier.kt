...
): Modifier = this then FocusChangedElement { onFocusChanged(it) }

internal fun Modifier.onFocusChanged(
    onFocusChanged: FocusEventModifierNode.(FocusState) -> Unit
): Modifier = this then FocusChangedElement(onFocusChanged)

private data class FocusChangedElement(
    val onFocusChanged: FocusEventModifierNode.(FocusState) -> Unit
