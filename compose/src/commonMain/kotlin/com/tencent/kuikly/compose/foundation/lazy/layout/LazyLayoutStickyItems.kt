...
internal fun <T : LazyLayoutMeasuredItem> StickyItemsPlacement?.applyStickyItems(
    ...
    return if (this != null && visibleItems.isNotEmpty() && stickyItems.isNotEmpty()) {
        ...
        val visibleStickyItems = visibleItems.fastFilter { stickyItems.contains(it.index) }

        // update sticking item offsets
        stickingItems.forEach { stickingIndex ->
            val itemIndex = visibleItems.indexOfFirst { it.index == stickingIndex }
