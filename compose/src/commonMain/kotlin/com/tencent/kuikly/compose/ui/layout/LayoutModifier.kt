...
import com.tencent.kuikly.compose.ui.layout.IntrinsicsMeasureScope
import com.tencent.kuikly.compose.ui.layout.LargeDimension

/**
 * A [Modifier.Element] that changes how its wrapped content is measured and laid out.
 * It has the same measurement and layout functionality as the [com.tencent.kuikly.compose.ui.layout.Layout]
 * component, while wrapping exactly one layout due to it being a modifier. In contrast,
 * the [com.tencent.kuikly.compose.ui.layout.Layout] component is used to define the layout behavior of
 * multiple children.
 *
 * @sample com.tencent.kuikly.compose.ui.samples.LayoutModifierSample
 *
 * @see com.tencent.kuikly.compose.ui.layout.Layout
 */
 ...
 * Example usage:
 *
 * @sample com.tencent.kuikly.compose.ui.samples.ConvenienceLayoutModifierSample
 *
 * @see com.tencent.kuikly.compose.ui.layout.LayoutModifier
 */
fun Modifier.layout(
