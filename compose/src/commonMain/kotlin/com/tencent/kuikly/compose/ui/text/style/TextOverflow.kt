...
value class TextOverflow internal constructor(internal val value: Int) {
    ...
    companion object {
         ...
         * @sample com.tencent.kuikly.compose.ui.text.samples.TextOverflowClipSample
         */
        @Stable
         ...
         * @sample com.tencent.kuikly.compose.ui.text.samples.TextOverflowEllipsisSample
         */
        @Stable
         ...
         *
         * @sample com.tencent.kuikly.compose.ui.text.samples.TextOverflowVisibleFixedSizeSample
         *
         ...
         *
         * @sample com.tencent.kuikly.compose.ui.text.samples.TextOverflowVisibleMinHeightSample
         *
