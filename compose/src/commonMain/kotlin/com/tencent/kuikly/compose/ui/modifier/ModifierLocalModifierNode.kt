...
/**
 * A [com.tencent.kuikly.compose.ui.Modifier.Node] that is capable of consuming and providing [ModifierLocal]
 * values.
 *
 * This is the [com.tencent.kuikly.compose.ui.Modifier.Node] equivalent of the [ModifierLocalConsumer]
 * and [ModifierLocalProvider] interfaces.
 *
 * @sample com.tencent.kuikly.compose.ui.samples.JustReadingOrProvidingModifierLocalNodeSample
 *
 * @see modifierLocalOf
 * @see ModifierLocal
